...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Pavel Fedarovich" /mediaBookList "AvalonWizard Reference" /productName "AvalonWizard Reference"
...
"%SYSTEMDRIVE%\Program Files\Microsoft Help Viewer\v2.0\HlpCtntMgr.exe" /operation uninstall /catalogName VisualStudio11 /locale en-us /vendor "Pavel Fedarovich"  /productName "AvalonWizard Reference" /bookList "AvalonWizard Reference"
