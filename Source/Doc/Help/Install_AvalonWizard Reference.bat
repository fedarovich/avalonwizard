...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Pavel Fedarovich" /mediaBookList "AvalonWizard Reference" /productName "AvalonWizard Reference" > NUL
...
IF EXIST "AvalonWizard Reference.msha" COPY /Y "AvalonWizard Reference.msha" HelpContentSetup.msha
...
"%SYSTEMDRIVE%\Program Files\Microsoft Help Viewer\v2.0\HlpCtntMgr.exe" /operation install /catalogName VisualStudio11 /locale en-us /sourceUri "%CD%\AvalonWizard Reference.msha"
